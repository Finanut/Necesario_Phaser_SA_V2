export default class Level2 extends Phaser.Scene {
    ...
    preload() {
        // Load assets for Level 2 theme - Desert
    ...
    create() {
        ...
        // Create platforms - custom layout for Level 2
        ...
        this.platforms.create(700, 320, 'ground').setScale(0.5).refreshBody();
        ...
        // Create initial stars (4 at a time for harder difficulty)
        for (let i = 0; i < 4; i++) {
            this.createStar();
        }
        ...
        // Create initial bombs (level 2 is harder)
        this.createBomb();
        ...
        // Add level indicator
        this.levelText = this.add.text(680, 16, 'Level: 2/3', { 
            fontSize: '24px', 
            fill: '#fff',
            fontFamily: 'Arial',
            strokeThickness: 2,
    ...
    createStar() {
        ...
        star.setVelocity(Phaser.Math.Between(-120, 120), 30); // Faster in level 2
    }
    ...
    createBomb() {
        ...
        bomb.setVelocity(Phaser.Math.Between(-220, 220), 30); // Faster bombs in level 2
    }
    ...
    collectStar(player, star) {
        ...
        // Create a bomb every 4 stars (more frequent than level 1)
        if (this.starsCollected % 4 === 0) {
            this.createBomb();
        }
